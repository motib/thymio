...
# To enabling demonstration of nondeterminism
#   if the center sensor (briefly) detects an obstacle
#   it makes a ND choice whether to approach or continue searching
# The choice is indicated on the circle leds
...
TIMER = 2000       # timer for changing direction
...
def prox():
  ...
  if state == 1 or state == 2:
    ...
    if prox_horizontal[2] > DETECTION and ran > 0:
      ...
      timer_period[0] = 0
      nf_leds_top(32,0,0)
    elif prox_horizontal[2] > DETECTION and ran < 0:
      nf_leds_circle(0,0,0,0,32,32,32,32)
      timer_period[0] = TIMER
    else:
      timer_period[0] = TIMER
